...
<p>
    <a href='halaman_input.php'>
        <input type='button' calss='btn btn-primary' value='Buah Halaman Baru' />
    </a>
</p>
<?php
    if($sukses){
        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="halaman.php?op=delete&id=<?php echo $r1['id']?>" onclick="return confirm('Apakah yakin untuk menghapus data?)">
...
<nav aria-label="page nagivation example">
    <ul class="pagination">
        <?php
        ...
        for($i=1; $i <= $pages; $i++){
            ?>
            <li class="page-item">
                <a class="pagelink" href="halaman.php?katakunci=<?php echo $katakunci?>&cari=<?php echo $cari?>&page=<?php echo $i ?>"></a>
            </li>
            <?php
        }
        ?>
